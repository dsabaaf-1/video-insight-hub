    ...
    <div className="flex flex-col items-center pt-20 pb-10 px-4">
      ...
      <div className="flex items-center justify-center gap-3 mt-8">
        <button
          ...
          className="bg-amber-500 hover:bg-amber-600 text-white text-[15px] font-medium w-[280px] h-[48px] rounded-btn transition-all duration-200 flex items-center justify-center gap-2"
        >
          <Upload size={18} />
          Upload video file
        </button>
